...
function getPostCountPerClassWithSameGradeData1() {
	$.ajax({
        type: "GET",
        url: '/admin/get-post-count-per-class-same-grade-data-1',
...
function getPostCountPerClassWithSameGradeData2() {
	$.ajax({
        type: "GET",
        url: '/admin/get-post-count-per-class-same-grade-data-2',
        success: function( returndata ) {
...
function getMarkCountPerClassWithSameGradeData1() {
	$.ajax({
        type: "GET",
        url: '/admin/get-mark-count-per-class-same-grade-data-1',
        success: function( returndata ) {
...
function getMarkCountPerClassWithSameGradeData2() {
	$.ajax({
        type: "GET",
        url: '/admin/get-mark-count-per-class-same-grade-data-2',
        success: function( returndata ) {
