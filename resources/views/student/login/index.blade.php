...
<a-scene>
    ...
    <a-box src="/images/panorama/sijiaguoyuduo.png" rotation="45 45 45" position="1.5 0.25 1.5" id="target1" value="1">
    ...
    <a-box src="/images/panorama/wubingliujinyun.png" rotation="45 45 45" position="1.5 0.25 -1.5" id="target2" value="2">
    ...
    <a-box src="/images/panorama/wudingshenweitao.png" rotation="45 45 45" position="-1.5 0.25 -1.5" id="target3" value="3">
        <!-- <a-animation attribute="position" to="-2 0.25 -2" direction="alternate" dur="2000" repeat="indefinite"></a-animation> -->
        <a-animation attribute="rotation" begin="click" to="360 360 360" direction="alternate" dur="2000"></a-animation>
    </a-box>
    <a-box src="/images/panorama/siyitangruiyao.png" rotation="45 45 45" position="-1.5 0.25 1.5" id="target4" value="4">
        <!-- <a-animation attribute="position" to="-2 0.25 2" direction="alternate" dur="2000" repeat="indefinite"></a-animation> -->
        <a-animation attribute="rotation" begin="click" to="360 360 360" direction="alternate" dur="2000"></a-animation>
    </a-box>
